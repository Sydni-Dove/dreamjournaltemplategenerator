...
## Documentation note — 2026-04-04

### Status correction (Not a fix) — recent April 4 investigation passes are not confirmed resolutions
...
### Parser (Labeled Uploads) — Recover leading narrative from single-block Brainstorm
